...
a = User.create!(username:"Uncle Mike", password: "hunter2")
...
story2 = Story.create!(title: "Eating Ice cream sundaes on a winter day", body: Faker::Hipster.paragraph_by_chars(characters: 2000, supplemental: false), author_id: d.id)
...
story4 = Story.create!(title: "Moshi Mosh desu desu", body: Faker::Hipster.paragraph_by_chars(characters: 2000, supplemental: false), author_id: b.id)
