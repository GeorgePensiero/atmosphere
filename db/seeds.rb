...
story1 = Story.create!(title: "Ice Cream Party!", body: Faker::Hipster.paragraph_by_chars(characters: 2000, supplemental: false), author_id: a.id)
file = open('https://atmosphere-aa-seeds.s3.amazonaws.com/doubleicecream.png')
story1.photo.attach(io: file, filename: 'teafarm.png')
story2 = Story.create!(title: "ljk;fsdjaljsdalk;fjl;dsajfsadl;", body: Faker::Hipster.paragraph_by_chars(characters: 2000, supplemental: false), author_id: a.id)
...
story3 = Story.create!(title: "f;lkdsajfl;kaewjgkl;ewjfkl;djsglkeaw", body: Faker::Hipster.paragraph_by_chars(characters: 2000, supplemental: false), author_id: b.id)
